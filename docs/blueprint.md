...
ConnectOS is a universal, adaptive, AI-augmented operating environment designed to run on top of any existing system (Android, Linux, Windows, iOS, KaiOS, or browser environments).
It does not replace or modify the host OS. Instead, it adds a secure execution layer that manages apps, environments, user experience, and the NexusPhi AI.
...
ConnectOS is structured into seven major layers:

+-------------------------------------------------------------+
|                    ConnectOS User Layer                     |
|        (Apps, WebApps, NexusPhi UI, OS Panels)              |
+-------------------------------------------------------------+
|                   NexusPhi AI Runtime Layer                 |
|  (Memory, Attention, Adapters, Permissions Manager, UI)     |
+-------------------------------------------------------------+
|                 ConnectOS Core Services Layer               |
...
NexusPhi always runs inside isolated containers and must request permission before:
...
Defines what capabilities NexusPhi or modules are allowed to use.
...
## 4. NexusPhi AI Architecture

NexusPhi is the adaptive intelligence of ConnectOS.
...
ConnectOS uses four execution modes:
...
Allows NexusPhi to interact with Android apps safely without rooting.
...
NexusPhi receives a list of allowed actions.
...
NexusPhi and ConnectOS adapt to:
